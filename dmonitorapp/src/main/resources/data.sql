-- Очистка базы перед созданием таблиц
TRUNCATE TABLE health_check_results RESTART IDENTITY CASCADE;
TRUNCATE TABLE service_definitions RESTART IDENTITY CASCADE;
TRUNCATE TABLE database_connection RESTART IDENTITY CASCADE;
...
VALUES
    ('main-db', 'jdbc:postgresql://localhost:5434/mydb', 'user', 'pass', 'org.postgresql.Driver')
    ON CONFLICT (name) DO NOTHING;